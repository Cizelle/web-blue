    ...
    return (
        <>
            ...
            <div className={styles.headerButtonsContainer}>
                ...
                <button className={styles.mainButton} onClick={() => handleReportFoundClick()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 12h-5m0 0l4 4m-4-4l4-4m-12 8a9 9 0 1 1 18 0a9 9 0 0 1-18 0z"></path></svg>
                    Report Found Person
                </button>
            </div>
